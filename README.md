...
Этот проект является продолжением [простого редактора изображений]([https://github.com/TheSkyEye1/AOCI-Simple-Image-Redactor-EmguCV](https://github.com/TheSkyEye1/AOCI-Lab1-Simple-Image-Redactior)) и углубляется в тему анализа и обработки цифровых изображений. Основной фокус здесь — работа с **цветовыми пространствами (RGB и HSV)** и применение более сложных алгоритмов цветокоррекции.
